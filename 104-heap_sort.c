...
/**
 * swap - This swap position of two elements
 * @array: for printing
 * @size: for printing
 ...
 * @ac_size: This the actual size for printing
 */
...
/**
 * heap_sort - This Sorts an array of integers in ascending order using Heap sort in the function
